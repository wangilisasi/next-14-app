...
export const metadata: Metadata = {
    title: 'Dynamic Fetching - Next App Router Tutorial',
   
  }


  export const revalidate = 0; // Revalidate whenever we refresh the page. When we refresh the page we get a new image
